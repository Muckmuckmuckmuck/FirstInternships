...
export const api = {
  ...
  async getProfile() {
    ...
    // as a SECURITY DEFINER RPC in the database.
    await sb.rpc("reset_credits_if_due").catch(() => {});
  ...
  async saveProfile(patch) {
    ...
    const SAFE = ["name","school","grad_year","major","experience","interest","marketing_consent","account_type"];
